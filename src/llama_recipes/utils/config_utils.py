...
def generate_dataset_config(train_config, kwargs):
    ...
    if dataset_config.dataset == 'opnqa_steering_dataset':
        ...
        dataset_config.train_split = dataset_config.train_split.format(dataset_path = dataset_path, attribute = attribute, group = group)
        dataset_config.valid_split = dataset_config.valid_split.format(dataset_path = dataset_path, attribute = attribute, group = group)
        dataset_config.test_split  = dataset_config.test_split.format(dataset_path = dataset_path, attribute = attribute, group = group)
    else:
